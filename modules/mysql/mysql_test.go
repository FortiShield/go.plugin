		...
		"MariaDB-Standalone[v10.8.4]: success on all queries": {
			{
				...
				check: func(t *testing.T, my *MySQL) {
					...
					expected := map[string]int64{
						...
						"threads_created":                            2,
						"threads_running":                            3,
						"userstats_khulnasoft_access_denied":         33,
						"userstats_khulnasoft_binlog_bytes_written":  0,
						"userstats_khulnasoft_commit_transactions":   0,
						"userstats_khulnasoft_cpu_time":              77,
						"userstats_khulnasoft_denied_connections":    49698,
						"userstats_khulnasoft_empty_queries":         66,
						"userstats_khulnasoft_lost_connections":      0,
						"userstats_khulnasoft_other_commands":        0,
						"userstats_khulnasoft_rollback_transactions": 0,
						"userstats_khulnasoft_rows_deleted":          0,
						"userstats_khulnasoft_rows_inserted":         0,
						"userstats_khulnasoft_rows_read":             0,
						"userstats_khulnasoft_rows_sent":             99,
						"userstats_khulnasoft_rows_updated":          0,
						"userstats_khulnasoft_select_commands":       33,
						"userstats_khulnasoft_total_connections":     1,
						"userstats_khulnasoft_update_commands":       0,
		...
		"Percona-Standalone[v8.0.29]: success on all queries": {
			{
				...
				check: func(t *testing.T, my *MySQL) {
					...
					expected := map[string]int64{
						...
						"threads_created":                            3,
						"threads_running":                            2,
						"userstats_khulnasoft_access_denied":         0,
						"userstats_khulnasoft_binlog_bytes_written":  0,
						"userstats_khulnasoft_commit_transactions":   0,
						"userstats_khulnasoft_cpu_time":              0,
						"userstats_khulnasoft_denied_connections":    0,
						"userstats_khulnasoft_empty_queries":         0,
						"userstats_khulnasoft_lost_connections":      0,
						"userstats_khulnasoft_other_commands":        1,
						"userstats_khulnasoft_rollback_transactions": 0,
						"userstats_khulnasoft_rows_fetched":          1,
						"userstats_khulnasoft_rows_updated":          0,
						"userstats_khulnasoft_select_commands":       1,
						"userstats_khulnasoft_total_connections":     1,
						"userstats_khulnasoft_update_commands":       0,
						"userstats_root_access_denied":               0,
						"userstats_root_binlog_bytes_written":        0,
